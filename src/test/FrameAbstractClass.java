...
public class FrameAbstractClass extends JFrame {
	...
	public ClassDefn abstractClass; // int type; // 0 for interface, 1 for abstract class, 2 for class/ concrete class
...
//			System.out.println(attributes);
	 ...
	 * Create the frame.
	 */
	public FrameAbstractClass() {
		abstractClass = new ClassDefn();
		...
		JLabel lblName = new JLabel("Abstract class Name");
		lblName.setBounds(12, 54, 116, 16);
	...
	private class SwingNode extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				Object newObj = Class.forName("test.FrameAbstractClass").cast(FrameAbstractClass.this);
				FrameNode frame = new FrameNode(newObj, "FrameAbstractClass");
				frame.setVisible(true);
...
//			frame.setVisible(true);
			...
			try {
				Object newObj = Class.forName("test.FrameAbstractClass").cast(FrameAbstractClass.this);
				FrameInstance frame = new FrameInstance(newObj, "FrameAbstractClass");
				frame.setVisible(true);
			} catch (ClassNotFoundException e1) {
				// TODO Auto-generated catch block
				e1.printStackTrace();
	...
	private class SwingAttribute extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			try {
				Object newObj = Class.forName("test.FrameAbstractClass").cast(FrameAbstractClass.this);
				FrameAttribute frame = new FrameAttribute(newObj, "FrameAbstractClass");
				frame.setVisible(true);
			} catch (ClassNotFoundException e1) {
				// TODO Auto-generated catch block
				e1.printStackTrace();
	...
	private class SwingSave extends AbstractAction {
		public SwingSave() {
			putValue(NAME, "Save");
			putValue(SHORT_DESCRIPTION, "Press here to save the abstract class.");
		}
		public void actionPerformed(ActionEvent e) {
